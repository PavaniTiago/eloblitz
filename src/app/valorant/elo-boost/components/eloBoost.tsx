...
export function EloBoost({ onActualRankSelect, onDesirebleRankSelect }: EloDialogProps){
    ...
    const isRankValid = () => {
        ...
        const rankOrder = ["Unranked", "Ferro", "Bronze", "Prata", "Ouro", "Platina", "Diamante", "Ascendente", "Immortal", "Radiante"];
