export const depoimentos = [
    ...
    },
    {
        nick: "dgo",
        rating: "★★★★",
        comment: "Tive uma boa experiência com a EloBlitz. O serviço de boosting foi eficiente e profissional. A única razão pela qual não dou cinco estrelas é que houve um pequeno atraso na comunicação no início, mas fora isso, tudo foi perfeito!"
    },
    {
        nick: "thoomie",
        rating: "★★★★",
        comment: "Não sabia se devia confiar em serviços de elojob, mas a EloBlitz provou ser muito confiável. O booster joga muito e ele é muito comunicativo, me mantendo informado durante todo o processo. Subi do Prata ao Ouro em 2 dias."
    },
    {
        nick: "vxnny",
        rating: "★★★★",
        comment: "Excelente serviço de elojob! Foram rápidos e profissional, uparam pro Prata em poucos dias. O booster caiu em uma partida, mas o suporte foi rápido em resolver. Recomendo!"
    },
    {
        nick: "ramiro",
